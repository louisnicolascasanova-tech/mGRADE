...
parser.add_argument('--dataset', type=str, choices=['cifar', 'mnist', 'imdb', 'listops'], help='Dataset for the sweep YAMLs')
...
for kernel_size, kernel_n_elems in kernel_configs.items():
    ...
    filename = f"{args.dataset}_{args.mode}_dcls_c{args.dcls_config}_wandb_{kernel_size}.yaml"
